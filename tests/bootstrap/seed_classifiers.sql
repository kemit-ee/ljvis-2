...
-- ============================================================
-- LABOUR_INSPECTION_VIOLATION — Tööinspektsiooni kontrolli rikkumised
-- ============================================================
DO $$
DECLARE
    v_created_by VARCHAR(100) := 'bootstrap-classifiers';
    ...
    v_rec        RECORD;
BEGIN
    IF NOT EXISTS (SELECT 1 FROM classifier.classifier WHERE code = 'LABOUR_INSPECTION_VIOLATION') THEN

        INSERT INTO classifier.classifier (classifier_key, code, name, description, created_by)
        VALUES (nextval('classifier.seq_classifier_key'), 'LABOUR_INSPECTION_VIOLATION',
                'Tööinspektsiooni kontrolli rikkumised',
                'Tööinspektsiooni kontrollvormi rikkumiste klassifikaator (EL 2016/403, Määrus 1072/2009, Määrus 1073/2009)', v_created_by)
        RETURNING classifier_key INTO v_clf_key;
