              ...
              <Card className="mb-1">
                <Card.Content>
                  ...
                  <ChoiceGroup
                    id="transportNature"
                    label={
                      <strong>{t('forms.sp_form.transportNature')}</strong>
                    }
                    ...
                    <AccordionItemContent>
                      ...
                      <div className={styles['days-row']}>
                        ...
                        <TextField
                          ...
                          label=""
                          value={
                            formik.values.checkedDaysCount?.toString() || ''
                          }
                          placeholder={t('Nr')}
                          onChange={(v) => {
                        ...
                        />
                        <Text>
                          {t('forms.drive_rest.otherActivityDaysCount')}
                        </Text>
                        <TextField
                          className={styles['days-number']}
