                ...
                OTHER.VEHICLE_CATEGORY ? (
                  <TextField
                    ...
                    formik.errors.vehicleCategoryOther
                      ? {
                          helper: {
                            text: formik.errors.vehicleCategoryOther as string,
                            type: 'error' as const,
                          },
                        }
                      : {})}
                  ...
                  <div className={gridClass}>
                    ...
                    <Select
                      ...
                      formik.errors.companyCountryCode
                        ? {
                            helper: {
                              text: formik.errors.companyCountryCode as string,
                              type: 'error' as const,
                            },
                          }
                        : {})}
                    ...
                    <Select
                      ...
                      value={
                        companyCitiesParishes
                          .map((c) => ({ value: String(c.id), label: c.name }))
                          .find((o) => o.value === formik.values.companyCity) ??
                        null
                      }
                      onChange={(val) =>
                        formik.setFieldValue(
              ...
              <div className={gridClass}>
                ...
                <Select
                  ...
                  formik.errors.inspectorOrganisationId
                    ? {
                        helper: {
                          text: formik.errors.inspectorOrganisationId as string,
                          type: 'error' as const,
                        },
                      }
                    : {})}
