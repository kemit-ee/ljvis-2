...
import { Button, Heading, Text, Alert, Row, Col, Card, StatusBadge, Search, Checkbox } from '@tedi-design-system/react/tedi';
...
export function ClassifierDetailPage() {
  ...
  const [showClassifierEditedAlert, setShowClassifierEditedAlert] = useState(false);
  const [showClassifierValueEditedAlert, setShowUserClassifierValueEditedAlert] = useState(false);
  ...
  const {
      ...
      setPagination,
      sorting,
      setSorting } = useClassifierDetail(id);
  ...
  const { formik } = useClassifierForm(classifier ?? undefined, handleEditSaved);
      ...
      () => [
          ...
          classifierColumnHelper.accessor('isValid', {
              ...
              cell: (info) => {
                  ...
                  const label = s ? t('classifiers.statusActive') : t('classifiers.statusInactive');
  ...
  return (
    <div>
      ...
      <Button visualType="link" onClick={() => navigate('/classifiers')} iconLeft="arrow_back">
        {t('common.back')}
      </Button>
              ...
              <Card.Content>
                  <div className="card-main">
                      ...
                      {canEditClassifierValue && (
                          <Button onClick={() => navigate(`/classifiers/${id}/value`)}>{t('classifiers.addValue')}
                          </Button>
                      )}
                  </div>
                  <div className="grid-2col">
                      <div className="search-wrapper">
                          <Search
                              ...
                              onIconClick={() => handleClassifierValueSearch(classifierValueSearchInput)}
