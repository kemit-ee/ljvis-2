...
export const getClassifierValues = (params: { classifierId: string; search?: string; page?: string; pageSize?: string; sorting?: string }) =>
    get<ClassifierValue[]>('/classifiers/get-values', params as Record<string, string>);

export const updateClassifier = (data: { id: string; name: string; description: string; }) =>
