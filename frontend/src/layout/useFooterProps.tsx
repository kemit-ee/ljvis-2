...
export function useFooterProps(): FooterProps {
  ...
  return {
    ...
    categories: [
      {
        elements: [
          <Text key="dept-label" modifiers={['bold', 'h6']}>
            {t('footer.department')}
          </Text>,
          <Anchor
            key="dept-email"
            color="inverted"
            href="mailto:ljvis@kliimaministeerium.ee"
          >
            ljvis@kliimaministeerium.ee
          </Anchor>,
          <Anchor key="dept-phone" color="inverted" href="tel:+3726262802">
