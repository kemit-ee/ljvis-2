...
Kõik Ruuteri kaudu eksponeeritud otspunktid. Mock-otspunktid on eraldi sektsioonis. Klassifikaatorite laadimise ja esiküljel kehtiva kešši täpsem kirjeldus on dokumendis [`classifier-caching.md`](classifier-caching.md).
