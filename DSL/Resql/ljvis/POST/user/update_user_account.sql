/*
description: Update user data — copy latest snapshot with new field values and status (replaces v1 insert_user_account_data_state
  + insert_user_account_state + rebuild)
namespace: user
params:
  user_account_id:
    type: integer
