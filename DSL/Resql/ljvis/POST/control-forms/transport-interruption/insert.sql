/*
description: Insert transport-interruption sub-form (autoveo katkestamise kontrollvorm) — first save.
  Free-text fields are uppercased server-side (LJVIS2-74 §4).
