...
description: Update the X-tee block fields IN PLACE on the latest snapshot row of a trailer technical-check
  sub-form. Does not append a new snapshot and does not bump version (LJVIS2-72 §4). Caller (Ruuter .guard)
  must already have verified control_form.edit_locked and that the latest snapshot status is confirmed.
