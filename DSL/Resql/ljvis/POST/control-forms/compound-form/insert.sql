...
VALUES (
  ...
  'koond-' || EXTRACT(YEAR FROM CURRENT_DATE) || '-' || LPAD(currval('forms.seq_compound_form_key')::text, GREATEST(5, LENGTH(currval('forms.seq_compound_form_key')::text)), '0'),
