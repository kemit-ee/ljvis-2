/*
description: "Read a snapshot scoped to its NU message."
namespace: erru
params:
  snapshotId:
    type: integer
    required: false
    description: Exact snapshot ID, scoped to the NU logical key
  id:
    type: integer
    required: false
...
WHERE nu_message_key = :id::BIGINT AND id = :snapshotId::BIGINT
