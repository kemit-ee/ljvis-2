/*
description: 'X-tee RegisterJobInspection_v3: INSERT INTO forms.labour_inspection_form. Uuem leping —
  lisaks v1 väljadele: sõiduki andmed controls_matrix JSONB-s, juhi isikukood ja nimi, menetluse liik.
  Idempotentsuse võti: external_inspection_id = ''v3-'' || kontrolli_id. ON CONFLICT DO NOTHING: korduspäring
  sama id-ga ei tekita duplikaati.'
namespace: xroad
params:
