...
-- changeset ljvis:20260828240000 splitStatements:false
--
-- ERRU NCR klassifikaatorid (11 tk): NCR_REQUEST_STATUS, NCR_RESPONSE_STATUS,
-- NCR_ACK_STATUS, NCR_CHECK_RESULT, NCR_INFRINGEMENT_CATEGORY,
-- NCR_PENALTY_TYPE_REQUESTED, NCR_PENALTY_TYPE_IMPOSED_REQ,
-- NCR_PENALTY_TYPE_IMPOSED_RES, NCR_IS_EXECUTED, NCR_REQUEST_SOURCE, NCR_REQUEST_PURPOSE.
-- Idempotentne: olemasolevad klassifikaatorid jäetakse vahele.
-- NCR permissions on eraldi migratsioonifailis: 20260828110000-initial-permissions-erru.sql
