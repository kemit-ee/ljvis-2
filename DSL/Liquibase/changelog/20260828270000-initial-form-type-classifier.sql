...
-- changeset ljvis:20260828270000 splitStatements:false
--
-- FORM_TYPE — kontrollvormi tüüp (hierarhiline, 2 taset).
-- Idempotentne: kui FORM_TYPE juba eksisteerib, jäetakse INSERT vahele.
