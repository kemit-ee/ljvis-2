...
-- changeset ljvis:20260828205000 splitStatements:false
--
-- COUNTRY — Riik (ISO 3166-1, 247 kirjet).
-- Kasutatakse ERRU sõnumivahetuses (CTUD, CGR, RSI, NCR) ja hea maine vormil.
-- Idempotentne: kui COUNTRY juba eksisteerib, jäetakse INSERT vahele.
...
BEGIN
    ...
    VALUES (nextval('classifier.seq_classifier_key'), 'COUNTRY',
            'Riik',
            'Riikide ja territooriumide klassifikaator (ISO 3166-1). Kasutatakse ERRU sõnumivahetuses ja hea maine vormil.',
            'ljvis2')
