...
-- changeset ljvis:20260828275000 splitStatements:false
--
-- Välisriigi rikkumine: EU_INFRINGEMENT, CARGO_CABOTAGE_VIOLATION, PASSENGER_CABOTAGE_VIOLATION.
-- Idempotentne: olemasolevad klassifikaatorid jäetakse vahele (IF NOT EXISTS muster).
            ...
            FOR v_rec IN
                ...
                LOOP
                    ...
                    VALUES (
                               ...
                               v_clf_key, v_rec.code, v_rec.name,
                               CURRENT_DATE, NULL, v_rec.description, v_created_by
                           );
                END LOOP;
        ELSE
